...
export class CreateTraduction extends Component {
  ...
  handleSubmit = () => {
    if (
      !localStorage.parallelHightlight ||
      localStorage.parallelHightlight == 0
    ) {
      ...
      case "update":
        ...
        Meteor.call("traduction.updateOne", traduction, (err, result) => {
          if (err) {
            ...
            Bert.alert(
              "La traduction a été mise a jour",
              "success",
              "growl-top-right"
            );
            this.setState({
  ...
  useTextArea(side, other) {
    ...
    let nbChild = 0;
    while ((nodeToCount = nodeToCount.previousSibling) != null) nbChild++;
          ...
          <form className="form-group">
            ...
            <div className="card-body">
              <div className="container">
                ...
                <div className="container row">
                  <div className="col-12 form-group">
                    <label htmlFor="videoLink">
                      Lien vers la video de la musique
                    </label>
                    <input
                      type="text"
                      name="videoLink"
                ...
                <input
                  className="btn btn-success container col-4"
                  type="button"
