      ...
      return (
        <div className="container row">
          <div className="col-12 alert alert-info">
            À ma grande déception, l'outil ci-dessous ne peut développer son
            plein potentiel uniquement sous chrome pour l'instant, Firefox m'a
            trahi :(
          </div>
        </div>
      );
        ...
        <div className="alert alert-info form-inline parallelHightlight-parent">
          <label className="switch">
            ...
            <span
              ...
              onClick={() => this.changeParallelHightlight()}
            />
          </label>
